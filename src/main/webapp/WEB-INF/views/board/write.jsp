				...
				<form class="board-form" method="post"
					...
					<c:choose>
						...
						<c:when test="${flag == false }">
							...
							<input type='hidden' name='oNo' value="1" /> 
						...
						<c:otherwise>
							...
							<input type='hidden' name='hit' value="0"/>
							<input type='hidden' name='flag' value='${flag }' />
							<input type='hidden' name='oNo' value='${oNo+1 }' /> 
					...
					<div class="bottom">
						<a href="${pageContext.servletContext.contextPath }/board?kwd=">취소</a> <input type="submit" value="등록">
					</div>
				</form>
			</div>
		</div>
